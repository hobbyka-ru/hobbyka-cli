...
Официальный открытый плагин Hobbyka для ИИ-агентов, версия `0.7.1`. Агент использует CLI и удалённый MCP для поиска товаров, локального сопоставления по фотографии, запроса проектных материалов, проверки серверных цен и подготовки коммерческих предложений.
