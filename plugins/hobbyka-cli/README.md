...
Официальный открытый плагин Hobbyka для ИИ-агентов с локальным терминалом, версия `0.7.2`. Агент использует CLI для поиска товаров, локального сопоставления по фотографии, запроса проектных материалов, проверки серверных цен и подготовки коммерческих предложений.
